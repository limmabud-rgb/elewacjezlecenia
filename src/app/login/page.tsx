...
setBlad(dane.blad ?? "Nieprawidłowy email lub hasło.");
setWysylanie(false);
}
} catch {
...
<p className="opis">Wpisz dane logowania, aby zobaczyć listę zleceń.</p>
...
<button type="submit" disabled={wysylanie || !haslo || !email}>
